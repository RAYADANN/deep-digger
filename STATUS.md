...
- `/coins <N>`, `/reset`, `/maxlvl`, `/skiptut`, `/rebirth [N]`, `/daily`, `/setday <N>`, `/resetdaily`, `/boost <min>`, `/leaderboard refresh`, `/egg [N]`, `/hatch`, `/pet <id>`, `/clearpets`, `/grantpass <key>`, `/grantproduct <key> [N]`, `/discover <oreId>`, `/discoverall`, `/resetjournal`, `/devhelp` — только Studio
- `/help` — список
...
- Последний коммит: `55b6a7c` — Pets MVP (2026-06-03). **Фазы 12–13 реализованы, ждут коммита.**
- GitHub: `github.com/RAYADANN/deep-digger`
- Объём `src/`: **~15k+ строк / ~91 .lua файлов** (после Фаз 12–13; +DiscoveryLogic, DiscoveryManager, JournalPanel, OreEntry, OreDiscoveryFX)
