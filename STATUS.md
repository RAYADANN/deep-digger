...
> Обновлено: 2026-06-03 (Фаза 11 закрыта — Pets MVP: 10 петов, Basic Egg, hatch 1×/10× с FX, парящий питомец, эффекты damage/luck/coin/multiMine; ждёт коммита)
...
- `/coins <N>`, `/reset`, `/maxlvl`, `/skiptut`, `/rebirth [N]`, `/daily`, `/setday <N>`, `/resetdaily`, `/boost <min>`, `/leaderboard refresh`, `/egg [N]`, `/hatch`, `/pet <id>`, `/clearpets`, `/devhelp` — только Studio
- `/help` — список
...
- Последний коммит: `db169bc` — «Complete MVP phases 6-10: ore data, juice, tutorial, rebirth, daily, leaderboard» (2026-06-03). **Фаза 11 (Pets MVP) реализована, ждёт коммита.**
- GitHub: `github.com/RAYADANN/deep-digger`
- Объём `src/`: **~13.5k строк / 82 .lua файла** (после Фазы 11; +8 файлов: PetDatabase, PetLogic, EggManager, PetManager, PetsPanel, PetCard, PetVisual, PetHatchFX)
